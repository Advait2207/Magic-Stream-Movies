...
import (
	...
	"github.com/Advait2207/Magic-Stream-Movies/Server/Magic-Stream-Movies-Server/models"
	"github.com/Advait2207/Magic-Stream-Movies/Server/Magic-Stream-Movies-Server/utils"
...
func RefreshTokenHandler(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil || claim == nil {
			fmt.Println("error", err.Error)
			c.JSON(http.StatusUnauthorized, gin.H{"error": "Invlaid or expired refresh token"})
			return
		}
